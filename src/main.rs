...
fn main() {
    ...
    let lat_1: f32 = matches.value_of("LAT_1").unwrap().parse().unwrap();
    let lon_1: f32 = matches.value_of("LON_1").unwrap().parse().unwrap();
    let lat_2: f32 = matches.value_of("LAT_2").unwrap().parse().unwrap();
    let lon_2: f32 = matches.value_of("LON_2").unwrap().parse().unwrap();
